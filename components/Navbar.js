...
const Navbar = () => {
    return (
        <div className='text-black bg-white w-[88vw] h-20 rounded-full mx-auto' >
            <div className='flex justify-between items-center h-20 p-3 font-semibold text-2xl'>
                <div className='flex gap-10'>
                    <div className='flex justify-center items-center pl-5'>
                        <h1 className='text-3xl'>Linktree</h1><img width={22} height={22} src='https://cdn.prod.website-files.com/666255f7f2126f4e8cec6f8f/666b48ad59add9f2777bb76f_download-2.svg' />
                    </div>
